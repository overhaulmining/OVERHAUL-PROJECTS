...
pages_roles = pd.DataFrame([
    ...
    {"pagina": "pages/empresa_nuevo.py", "nombre": "OT Equipos", "icono": "build", "roles": ["administrador"], "sidebar": False},
    {"pagina": "pages/ot_persona_edit.py", "nombre": "OT Equipos", "icono": "build", "roles": ["administrador"], "sidebar": False},
    {"pagina": "pages/curso_nuevo.py", "nombre": "OT Equipos", "icono": "build", "roles": ["administrador"], "sidebar": False},
